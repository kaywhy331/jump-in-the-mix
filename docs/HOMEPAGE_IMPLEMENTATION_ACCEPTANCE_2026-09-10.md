...
- Targets and contrast: every control in the panel is at least 44px tall (tabs, chips, Done, month arrows, days, slots). Day cells keep a fluid width so seven columns fit 320px and stay at least 24px wide on the Pixel 7 layout. Outside-month days no longer rely on an opacity fade that put them below 4.5:1. The open beat's gray title on its frame (a lighter step of the mix buttons' brand tint, `#f5f4ff`) computes to about 5.6:1 and the brand-colored beat number to about 7:1.
