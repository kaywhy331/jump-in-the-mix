...
Current release evidence comes from GitHub Actions, the migration and encrypted-restore rehearsals, and `docs/MANUAL_DEVICE_QUALIFICATION.md`. Live provider checks require separate staging credentials; physical Android Contact Picker coverage uses `docs/ANDROID_CONTACT_PICKER_QUALIFICATION.md`.
