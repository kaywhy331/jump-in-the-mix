export const ONBOARDING_USES = [
  { id: "business", label: "Business", description: "Stay close to customers and keep business opportunities moving.", reasons: ["Follow up about an estimate", "Check in after the job", "Ask for a review", "Reconnect", "General follow-up"] },
