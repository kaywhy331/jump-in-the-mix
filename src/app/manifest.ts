...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    shortcuts: [
      { name: "Today", short_name: "Today", url: "/jumps", icons: [{ src: "/icon-192.png?v=4", sizes: "192x192" }] },
      { name: "Add a person", short_name: "Add", url: "/contacts/new", icons: [{ src: "/icon-192.png?v=4", sizes: "192x192" }] }
    ]
  };
}
