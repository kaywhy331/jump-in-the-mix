...
export default async function ArchivedContactsPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div className="page archived-contacts-page">
      {query.restored && <Notice type="success">Contact restored.</Notice>}
