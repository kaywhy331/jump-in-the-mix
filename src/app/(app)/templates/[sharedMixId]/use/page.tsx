...
export const metadata: Metadata = { title: "Use ready-made plan" };
...
export default async function UseMixTemplatePage({ params, searchParams }: { params: Promise<{ sharedMixId: string }>; searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div className="page template-use-page">
      ...
      <header className="page-header"><div><h1>Use {shared.title}</h1><p>Choose who gets the plan and when it starts.</p></div></header>
