      ...
      <form action={saveSharedMixAdminAction} className="admin-template-editor-form">
        ...
        <section className="card">
          ...
          <div className="form-grid">
            ...
            <div className="field"><label htmlFor="triggerMode">Trigger mode</label><select id="triggerMode" name="triggerMode" defaultValue={templateMetadata?.triggerMode ?? "MANUAL_START"}><option value="MANUAL_START">Manual start</option><option value="DATE_TRIGGERED">Important Date Type</option><option value="BROADCAST">Broadcast draft</option></select></div>
            <div className="field"><label htmlFor="dateTypeName">Important Date Type name</label><input id="dateTypeName" name="dateTypeName" defaultValue={templateMetadata?.dateTypeName ?? ""} maxLength={120} /></div>
            <div className="field"><label htmlFor="dateTypeSlug">Important Date Type slug</label><input id="dateTypeSlug" name="dateTypeSlug" defaultValue={templateMetadata?.dateTypeSlug ?? ""} maxLength={120} /></div>
