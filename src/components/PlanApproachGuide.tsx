...
export function PlanApproachGuide({ plan, expanded = false }: { plan: SalesPlan; expanded?: boolean }) {
  ...
  return <details className="plan-approach-guide" open={expanded}>
    <summary>When and how to use this plan</summary>
    <dl>
      ...
      <dt>Adjust the timing</dt><dd>The {plan.durationDays}-day cadence is a starting point. Match it to the buyer's timing and remove steps that no longer fit.</dd>
      <dt>When they respond</dt><dd>Stop this plan for that person from their contact page when they reply, book, decline, or ask you to stop. Agree on the next step in the conversation. Replies are not detected automatically.</dd>
    </dl>
